...
import dad.javafx.micv.utils.LocalDateAdapter;
...
private ListProperty<Nacionalidad> nacionalidad= new SimpleListProperty<Nacionalidad>(FXCollections.observableList(new ArrayList<Nacionalidad>()));

public Personal() {}
public Personal(String identificacion,String nombre, String apellidos, LocalDate fechaNacimiento,String direccion,String codigoPostal, String localidad,String pais,ArrayList<Nacionalidad> nacionalidad) {
	...
	this.pais.set(pais);
	this.nacionalidad.addAll(nacionalidad);
